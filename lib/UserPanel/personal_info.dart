...
class _Personal_InformationState extends State<Personal_Information> {
 ...
 void getInfo ()async {
    ...
    setState(() {
      if(mRef!=null){
        applicantNameController.text = mRef["name"];
        applicFatherNameController.text = mRef["fathername"];
        adressController.text =mRef['adress'];
        domicileController.text =mRef['domicile'];
        programController.text =mRef['program'];
        cnicController.text =mRef['cnic'];
        getDate =mRef['date'];
      }
